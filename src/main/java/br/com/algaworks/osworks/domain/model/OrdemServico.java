...
//	Validações não são necessárias nas classes modelo de entidade.
//	Todas as validações são feitas no modelo de representação, na API.
...
//	@JsonProperty(access = Access.READ_ONLY)
	...
	public void setDataFinalizacao(OffsetDateTime dataFechamento) {
		this.dataFinalizacao = dataFechamento;
	}
